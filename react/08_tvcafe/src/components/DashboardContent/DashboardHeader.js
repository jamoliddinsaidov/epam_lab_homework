...
import { faFilm, faUserFriends, faBell } from '@fortawesome/free-solid-svg-icons'
import { getNotificationsLength } from '../../utils/localStorageConfig'

const Header = ({ user }) => {
  // states
  const [notificationsLength, setNotificationsLength] = useState(getNotificationsLength())
