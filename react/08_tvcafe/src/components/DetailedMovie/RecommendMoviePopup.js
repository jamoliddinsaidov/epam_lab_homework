...
// utils
import { checkLocalStorageCurrentUser, recommendMovie } from '../../utils/localStorageConfig'
import { colors } from '../GlobalStyles'
import { formatWithComma } from '../../utils/formatString'

const RecommendMoviePopup = ({ isRecommendClicked, setIsRecommendClicked, details, setShowSuccessMsg }) => {
  // states
  ...
  return (
    <StyledRecommendContainer className={isRecommendClicked ? 'popup' : ''}>
      <div>
        ...
        {user.friends.length === 0 ? <h4>Seems like you are not following anyone...</h4> : ''}
      </div>
