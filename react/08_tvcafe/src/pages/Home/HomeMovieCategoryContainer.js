...
const HomeMovieCategoryContainer = ({ isActive, setIsActive }) => {
  ...
  return (
    <StyledHomeMovieCategoryContainer>
      ...
      <StyledHomeOptions>
        <button onClick={clickHandler} className={isActive.popularBtn ? 'active' : ''}>
          popular shows
        </button>
        <button onClick={clickHandler} className={isActive.animationBtn ? 'active' : ''}>
          animations
        </button>
        <button onClick={clickHandler} className={isActive.helpBtn ? 'active' : ''}>
